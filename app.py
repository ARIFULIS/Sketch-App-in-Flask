...
UPLOAD_FOLDER = 'C:\\Users\\DarkSpot\\PycharmProjects\\Sketch App in Flask\\static\\uploads'
...
def make_sketch(img):
    ...
    blurred = cv2.GaussianBlur(inverted,
                               ...
                               sigmaX=0,
                               sigmaY=0)
    final_result = cv2.divide(grayed,
                              255 - blurred,
                              scale=256)
    return final_result
...
def sketch():
    ...
    if file and allowed_file(file.filename):
        ...
        _ = cv2.imwrite(UPLOAD_FOLDER + '/' + sketch_img_name,
                        sketch_img)
        return render_template('home.html',
